...
class ReportFieldsEnum extends Enum
{
    /**
    ...
    /**
     * Название условия показа:
     *  Для показа по ключевой фразе или синониму — текст ключевой фразы.
     *  Для показа по автоматически добавленной фразе:
     *      пустое значение, если тип отчета — CUSTOM_REPORT;
     *      текст автоматически добавленной фразы, если тип отчета — SEARCH_QUERY_PERFORMANCE_REPORT.
     *  Для показа по условию нацеливания на аудиторию — название условия подбора аудитории
     *  или название интереса к категории мобильных приложений.
     *  Для показа динамических объявлений — название условия нацеливания для динамических объявлений или название фильтра.
     *  Для показа смарт-баннеров — название фильтра (возможность находится в закрытом бета-тестировании).
     */
    public const CRITERIA = 'Criteria';

    /**
     * Идентификатор условия показа:
     *  Для показа по ключевой фразе или по синониму — идентификатор фразы.
     *  Для показа по автоматически добавленной фразе — прочерк.
     *  Для показа по условию нацеливания на аудиторию — идентификатор условия нацеливания на аудиторию.
     *  Для показа динамических объявлений — идентификатор условия нацеливания для динамических объявлений
     *  или идентификатор фильтра.
     *  Для показа смарт-баннеров — идентификатор фильтра (возможность находится в закрытом бета-тестировании)
     */
